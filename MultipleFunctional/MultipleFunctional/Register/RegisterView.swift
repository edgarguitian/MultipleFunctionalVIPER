    ...
    var body: some View {
        VStack {
            ...
            Group {
                ...
                Button("accept") {
                    presenter.createNewUser(email: textFieldEmail,
                ...
                if let messageError = presenter.showErrorMessageRegister {
                    Text(messageError)
                        .bold()
                        .font(.body)
                        .foregroundColor(.red)
        ...
        .onAppear {
            presenter.showErrorMessageRegister = nil
        }
    }
}

#Preview {
    AuthRouter().showRegister()
}
